...
public enum WCEvent: String {
    ...
    case cosmostationSignDirectTx = "cosmostation_wc_sign_direct_tx_v1"
...
extension WCEvent {
    ...
    static let cosmostation = Set<WCEvent>([.cosmostationAccounts, .cosmostationSignTx, .cosmostationSignDirectTx])
